...
export LoadConfig_Lab2B
export _LoadConfig_Lab2B
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab2B
	lcall	LoadConfigTBL_Lab2B_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab2B
;
;    Load configuration registers for Lab2B.
...
_LoadConfig_Lab2B:
 LoadConfig_Lab2B:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab2B_Bank0
    mov     X, <LoadConfigTBL_Lab2B_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab2B_Bank1
    mov     X, <LoadConfigTBL_Lab2B_Bank1
