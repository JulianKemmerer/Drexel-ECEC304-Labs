...
export LoadConfig_lab4b
export _LoadConfig_lab4b
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab4b
	lcall	LoadConfigTBL_lab4b_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab4b
;
;    Load configuration registers for lab4b.
...
_LoadConfig_lab4b:
 LoadConfig_lab4b:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab4b_Bank0
    mov     X, <LoadConfigTBL_lab4b_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab4b_Bank1
    mov     X, <LoadConfigTBL_lab4b_Bank1
