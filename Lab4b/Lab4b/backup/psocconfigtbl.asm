...
export LoadConfigTBL_lab4b_Bank1
export LoadConfigTBL_lab4b_Bank0
export LoadConfigTBL_lab4b_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab4b_Bank0:
;  Instance name LCD, User Module LCD
;  Instance name PWM8, User Module PWM8
;       Instance name PWM8, Block Name PWM8(DBB00)
	db		23h, 00h		;PWM8_CONTROL_REG(DBB00CR0)
	db		21h, ffh		;PWM8_PERIOD_REG(DBB00DR1)
	db		22h, 00h		;PWM8_COMPARE_REG(DBB00DR2)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_lab4b_Bank1:
;  Instance name LCD, User Module LCD
;  Instance name PWM8, User Module PWM8
;       Instance name PWM8, Block Name PWM8(DBB00)
	db		20h, 21h		;PWM8_FUNC_REG(DBB00FN)
	db		21h, 15h		;PWM8_INPUT_REG(DBB00IN)
	db		22h, 04h		;PWM8_OUTPUT_REG(DBB00OU)
