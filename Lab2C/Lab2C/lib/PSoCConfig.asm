...
export LoadConfig_Lab2C
export _LoadConfig_Lab2C
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab2C
	lcall	LoadConfigTBL_Lab2C_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab2C
;
;    Load configuration registers for Lab2C.
...
_LoadConfig_Lab2C:
 LoadConfig_Lab2C:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab2C_Bank0
    mov     X, <LoadConfigTBL_Lab2C_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab2C_Bank1
    mov     X, <LoadConfigTBL_Lab2C_Bank1
