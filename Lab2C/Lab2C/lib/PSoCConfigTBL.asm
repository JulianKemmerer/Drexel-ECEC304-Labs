...
export LoadConfigTBL_Lab2C_Bank1
export LoadConfigTBL_Lab2C_Bank0
export LoadConfigTBL_Lab2C_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab2C_Bank0:
