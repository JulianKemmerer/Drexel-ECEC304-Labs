...
export LoadConfigTBL_Lab2B_Bank1
export LoadConfigTBL_Lab2B_Bank0
export LoadConfigTBL_Lab2B_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab2B_Bank0:
