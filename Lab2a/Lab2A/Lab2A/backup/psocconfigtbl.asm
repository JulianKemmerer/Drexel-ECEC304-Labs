...
export LoadConfigTBL_Lab2A_Bank1
export LoadConfigTBL_Lab2A_Bank0
export LoadConfigTBL_Lab2A_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab2A_Bank0:
