...
export LoadConfig_Lab2A
export _LoadConfig_Lab2A
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab2A
	lcall	LoadConfigTBL_Lab2A_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab2A
;
;    Load configuration registers for Lab2A.
...
_LoadConfig_Lab2A:
 LoadConfig_Lab2A:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab2A_Bank0
    mov     X, <LoadConfigTBL_Lab2A_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab2A_Bank1
    mov     X, <LoadConfigTBL_Lab2A_Bank1
