...
export LoadConfigTBL_lab1c_Bank1
export LoadConfigTBL_lab1c_Bank0
export LoadConfigTBL_lab1c_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab1c_Bank0:
