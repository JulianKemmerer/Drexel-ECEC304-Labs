...
export LoadConfig_lab1c
export _LoadConfig_lab1c
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab1c
	lcall	LoadConfigTBL_lab1c_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab1c
;
;    Load configuration registers for lab1c.
...
_LoadConfig_lab1c:
 LoadConfig_lab1c:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab1c_Bank0
    mov     X, <LoadConfigTBL_lab1c_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab1c_Bank1
    mov     X, <LoadConfigTBL_lab1c_Bank1
