...
export LoadConfigTBL_Lab2G_Bank1
export LoadConfigTBL_Lab2G_Bank0
export LoadConfigTBL_Lab2G_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab2G_Bank0:
