...
export LoadConfig_Lab2G
export _LoadConfig_Lab2G
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab2G
	lcall	LoadConfigTBL_Lab2G_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab2G
;
;    Load configuration registers for Lab2G.
...
_LoadConfig_Lab2G:
 LoadConfig_Lab2G:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab2G_Bank0
    mov     X, <LoadConfigTBL_Lab2G_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab2G_Bank1
    mov     X, <LoadConfigTBL_Lab2G_Bank1
