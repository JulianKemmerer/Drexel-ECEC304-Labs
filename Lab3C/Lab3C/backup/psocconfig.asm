...
export LoadConfig_lab3c
export _LoadConfig_lab3c
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab3c
	lcall	LoadConfigTBL_lab3c_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab3c
;
;    Load configuration registers for lab3c.
...
_LoadConfig_lab3c:
 LoadConfig_lab3c:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab3c_Bank0
    mov     X, <LoadConfigTBL_lab3c_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab3c_Bank1
    mov     X, <LoadConfigTBL_lab3c_Bank1
