...
export LoadConfigTBL_lab3c_Bank1
export LoadConfigTBL_lab3c_Bank0
export LoadConfigTBL_lab3c_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab3c_Bank0:
...
;  Global Register values Bank 0
	...
	db		b3h, 36h		; Row_0_LogicSelect_0 register (RDI0LT0)
...
;  Instance name PWM8_2, User Module PWM8
;       Instance name PWM8_2, Block Name PWM8(DBB01)
	db		24h, 31h		;PWM8_2_FUNC_REG(DBB01FN)
	db		25h, 11h		;PWM8_2_INPUT_REG(DBB01IN)
	db		26h, 05h		;PWM8_2_OUTPUT_REG(DBB01OU)
;  Global Register values Bank 1
	...
	db		dfh, 7fh		; OscillatorControl_3 register (OSC_CR3)
...
;  Ordered Global Register values
	...
	mov	reg[05h], e7h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], e7h		; Port_1_DriveMode_2 register (PRT1DM2)
