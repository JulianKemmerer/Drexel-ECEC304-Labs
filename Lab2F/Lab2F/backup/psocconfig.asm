...
export LoadConfig_Lab2E
export _LoadConfig_Lab2E
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab2E
	lcall	LoadConfigTBL_Lab2E_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab2E
;
;    Load configuration registers for Lab2E.
...
_LoadConfig_Lab2E:
 LoadConfig_Lab2E:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab2E_Bank0
    mov     X, <LoadConfigTBL_Lab2E_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab2E_Bank1
    mov     X, <LoadConfigTBL_Lab2E_Bank1
