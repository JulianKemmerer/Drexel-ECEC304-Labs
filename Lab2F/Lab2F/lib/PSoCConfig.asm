...
export LoadConfig_Lab2F
export _LoadConfig_Lab2F
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab2F
	lcall	LoadConfigTBL_Lab2F_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab2F
;
;    Load configuration registers for Lab2F.
...
_LoadConfig_Lab2F:
 LoadConfig_Lab2F:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab2F_Bank0
    mov     X, <LoadConfigTBL_Lab2F_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab2F_Bank1
    mov     X, <LoadConfigTBL_Lab2F_Bank1
