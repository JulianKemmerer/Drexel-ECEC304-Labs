...
export LoadConfigTBL_Lab2F_Bank1
export LoadConfigTBL_Lab2F_Bank0
export LoadConfigTBL_Lab2F_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab2F_Bank0:
