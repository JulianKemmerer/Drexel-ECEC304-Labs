...
;  Instance name BaudClock, User Module PWM8
;       Instance name BaudClock, Block Name PWM8(DBB00)
	db		23h, 00h		;BaudClock_CONTROL_REG(DBB00CR0)
	db		21h, 33h		;BaudClock_PERIOD_REG(DBB00DR1)
	db		22h, 19h		;BaudClock_COMPARE_REG(DBB00DR2)
...
;  Instance name BaudClock, User Module PWM8
;       Instance name BaudClock, Block Name PWM8(DBB00)
	db		20h, 61h		;BaudClock_FUNC_REG(DBB00FN)
	db		21h, 14h		;BaudClock_INPUT_REG(DBB00IN)
	db		22h, 40h		;BaudClock_OUTPUT_REG(DBB00OU)
;  Instance name LCD, User Module LCD
;  Instance name TX8, User Module TX8
;       Instance name TX8, Block Name TX8(DCB02)
	db		28h, 0dh		;TX8_FUNC_REG     (DCB02FN)
	db		29h, 02h		;TX8_INPUT_REG    (DCB02IN)
	db		2ah, 47h		;TX8_OUTPUT_REG   (DCB02OU)
;  Global Register values Bank 1
	...
	db		dfh, 67h		; OscillatorControl_3 register (OSC_CR3)
