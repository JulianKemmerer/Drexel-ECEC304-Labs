...
export LoadConfigTBL_Lab1B_Bank1
export LoadConfigTBL_Lab1B_Bank0
export LoadConfigTBL_Lab1B_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab1B_Bank0:
...
;  Ordered Global Register values
	...
	mov	reg[04h], e1h		; Port_1_Data register (PRT1DR)
	M8C_SetBank1
