...
export LoadConfig_Lab1B
export _LoadConfig_Lab1B
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab1B
	lcall	LoadConfigTBL_Lab1B_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab1B
;
;    Load configuration registers for Lab1B.
...
_LoadConfig_Lab1B:
 LoadConfig_Lab1B:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab1B_Bank0
    mov     X, <LoadConfigTBL_Lab1B_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab1B_Bank1
    mov     X, <LoadConfigTBL_Lab1B_Bank1
