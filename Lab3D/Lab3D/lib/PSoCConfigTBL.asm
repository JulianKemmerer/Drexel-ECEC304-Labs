...
export LoadConfigTBL_Lab3D_Bank1
export LoadConfigTBL_Lab3D_Bank0
export LoadConfigTBL_Lab3D_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab3D_Bank0:
