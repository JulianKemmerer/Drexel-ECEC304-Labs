...
export LoadConfig_Lab3D
export _LoadConfig_Lab3D
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab3D
	lcall	LoadConfigTBL_Lab3D_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab3D
;
;    Load configuration registers for Lab3D.
...
_LoadConfig_Lab3D:
 LoadConfig_Lab3D:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab3D_Bank0
    mov     X, <LoadConfigTBL_Lab3D_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab3D_Bank1
    mov     X, <LoadConfigTBL_Lab3D_Bank1
