...
export LoadConfigTBL_Lab2E_Bank1
export LoadConfigTBL_Lab2E_Bank0
export LoadConfigTBL_Lab2E_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab2E_Bank0:
