...
export LoadConfig_Lab2D
export _LoadConfig_Lab2D
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Lab2D
	lcall	LoadConfigTBL_Lab2D_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Lab2D
;
;    Load configuration registers for Lab2D.
...
_LoadConfig_Lab2D:
 LoadConfig_Lab2D:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Lab2D_Bank0
    mov     X, <LoadConfigTBL_Lab2D_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Lab2D_Bank1
    mov     X, <LoadConfigTBL_Lab2D_Bank1
