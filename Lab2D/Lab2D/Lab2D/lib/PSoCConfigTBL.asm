...
export LoadConfigTBL_Lab2D_Bank1
export LoadConfigTBL_Lab2D_Bank0
export LoadConfigTBL_Lab2D_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Lab2D_Bank0:
